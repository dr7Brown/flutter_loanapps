...
class AddDepositeScreen extends StatefulWidget {
  const AddDepositeScreen({super.key});

  @override
  State<AddDepositeScreen> createState() => _AddDepositeScreenState();
}

class _AddDepositeScreenState extends State<AddDepositeScreen> {
